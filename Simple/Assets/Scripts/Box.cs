...
public class Box : MonoBehaviour {
	...
	void Start()
	{
		...
		Fruits = GameObject.Find("SceneController").GetComponent<SpawnContoller> ();
		timeController = GameObject.Find("SceneController").GetComponent<TimeController> ();
